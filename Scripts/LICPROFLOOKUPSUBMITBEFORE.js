/*------------------------------------------------------------------------------------------------------/
| SVN $Id: LicProfLookupSubmitBefore.js 3600 2008-10-27 21:36:24Z dane.quatacker $
| Program : LicProfLookupSubmitBeforeV1.5.js
...
function  targetCap = aa.cap.getCap(targetCapId).getOutput();
...
function 		{ logDebug("**ERROR: No cap detail script object : " + cdScriptObjResult.getErrorMessage()) ; return false; }
...
function sObj = gisObjResult.getOutput();
	else
...
function yFee.subGroup = fFee.getSubGroup();
