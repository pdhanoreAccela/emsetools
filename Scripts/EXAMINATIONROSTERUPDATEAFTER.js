...
function getParamsForUnschedule(rosterModel, capID)
{
	...
	setExamNameAndProviderNameByScheduleModel(rosterModel.getProviderEventModel().getrProviderScheduleModel());
...
function setExamNameAndProviderNameByScheduleModel(scheduleModel)
{
	var examMapResult = aa.examination.getExamNameAndProviderNameByScheduleModel(scheduleModel);
	if(examMapResult.getSuccess())
	{
	   var examMap = examMapResult.getOutput();
	   examName = examMap.get("examName");
