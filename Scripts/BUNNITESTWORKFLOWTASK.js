...
var wfStep ; var wfComment ; var wfNote ; var wfDue ; var wfHrsSpent ;	// Initialize
...
for (i in wfObj)
	...
	if (fTask.getTaskDescription().equals(wfTask) && (fTask.getProcessID() == wfProcessID))
		...
		wfTaskObj = fTask;
/* Add the hours spent value - ETW */
                wfHrsSpent = fTask.getHoursSpent();
		}
	}
...
logDebug("wfHrsSpent = " + wfHrsSpent); //ETW
...
/* Added to include estimated hours - ETW */
var wfEstHrs = aa.env.getValue("EstimatedHours");
logDebug("wfEstHrs = " + wfEstHrs);
