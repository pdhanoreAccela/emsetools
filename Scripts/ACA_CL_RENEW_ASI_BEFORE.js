/*------------------------------------------------------------------------------------------------------/
| Program : ACA CL Renew ASI Before.js
| Event   : ACA CL Renew ASI Before
|
...
var controlString = "ACA CL Renew PageFlowScript Before ASI";		// Standard choice for control
...
//if parcelNum is null, district is is added to all parcels on CAP
	...
	if (!parcelNum)
		...
		{
		apdResult = aa.parcel.addParceDistrictForDaily(capId.getID1(),capId.getID2(),capId.getID3Impact)
	{
...
function branchTask(wfstr,wfstat,wfcomment,wfnote) // optional process name
	{
	var useProcess = false;
	var processName = "YYYY-MM-DD or MM/DD/YYYY (default)
	{
	var mth = "";
	var day = "";
	var ret = "";
...
//if parcelNum is null, district is is added to all parcels on CAP
	...
	if (!parcelNum)
		...
		{
		apdResult = aa.parcel.addParceDistrictForDaily(capId.getID1(),capId.getID2(),capId.getID3omCapId to pToCapId
...
function createRefLicProf(rlpId,rlpType,pContactType)
	...
	newLic.setAuditDate(sysDateYYYY-MM-DD or MM/DD/YYYY (default)
	{
	var mth = "";
	var day = "";
	var ret = "";
...
//if parcelNum is null, district is is added to all parcels on CAP
	...
	if (!parcelNum)
		...
		{
		apdResult = aa.parcel.addParceDistrictForDaily(capId.getID1(),capId.getID2(),capId.getID31).toString() +"/"+jsStartDate.getDate()+"/"+jsStartDate.getFullYear() + " End Date: " + (jsEndDate.getMonth()+1).toString() +"/"+jsEndDate.getDate()+"/"+jsEndDate.getFullYear());
...
function getChildren(pCapType, pParentCapId)
	...
	for (xx in childArray)
		...
		if (isMatch)
			retArray.push(chilYYYY-MM-DD or MM/DD/YYYY (default)
	{
	var mth = "";
	var day = "";
	var ret = "";
...
//if parcelNum is null, district is is added to all parcels on CAP
	...
	if (!parcelNum)
		...
		{
		apdResult = aa.parcel.addParceDistrictForDaily(capId.getID1(),capId.getID2(),capId.getID3te);
...
function loadTaskSpecific(thisArr)
	{
 	...
 	// If useTaskSpecificGroupName==true, appends wf process codeYYYY-MM-DD or MM/DD/YYYY (default)
	{
	var mth = "";
	var day = "";
	var ret = "";
...
//if parcelNum is null, district is is added to all parcels on CAP
	...
	if (!parcelNum)
		...
		{
		apdResult = aa.parcel.addParceDistrictForDaily(capId.getID1(),capId.getID2(),capId.getID3tus,dispositionDate,wfnote,pComment,systemUserObj,"Y");
			...
			if (assignDate)
				...
				var adjustResult = aa.workflow.adjustTaskWithNoAudit(taskItem);
              				...
              				logDebug("Updated Workflow Task : " + wfstr + " Assigned Date to " + wfAssignDate);
                                        ...
                                        logDebug("Error updating wfTask : " +YYYY-MM-DD or MM/DD/YYYY (default)
	{
	var mth = "";
	var day = "";
	var ret = "";
...
//if parcelNum is null, district is is added to all parcels on CAP
	...
	if (!parcelNum)
		...
		{
		apdResult = aa.parcel.addParceDistrictForDaily(capId.getID1(),capId.getID2(),capId.getID3