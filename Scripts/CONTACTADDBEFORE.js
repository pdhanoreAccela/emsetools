/*------------------------------------------------------------------------------------------------------/
| SVN $Id: ContactAddBefore.js 3600 2008-10-27 21:36:24Z dane.quatacker $
| Program : ContactAddBeforeV1.5.js
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != null && stdDesc.length)
		...
		if (bizDomScriptResult.getSuccess())
			...
			logDebug("**ERROR creating Std Choice " + bizDomScript.ge && (pImpact==null || pImpact.toUpperCase()==cImpact.toUpperCase()) )
						{
...
function assignCap(assignId) // option CapId
	...
	if (cdWrite.getSuccess())
		...
		{ logDebug("**ERROR writing capdetail : " + cdWrite.getEPeriodList);
	if (invoiceResult.getSuccess())
		logMessage("Invoicing assessed fee items is successful.");
	else
		logMessage("**ERROR: Invoicing the fee items assessed to app # " + capIDString + " was not successful.  Reason: " +  invoiceResult.getErrorMessage());
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != null && stdDesc.length)
		...
		if (bizDomScriptResult.getSuccess())
			...
			logDebug("**ERROR creating Std Choice " + bizDomScript.gept model after 6.4  updated this function
	if (!newcap)
...
function copySchedInspections(pFromCapId, pToCapId)
	...
	if (!inspResultObj.getSuccess())
		{
		logMessage("**ERROR: Failed to get inspections: " + inspResultObj.getErrorMPeriodList);
	if (invoiceResult.getSuccess())
		logMessage("Invoicing assessed fee items is successful.");
	else
		logMessage("**ERROR: Invoicing the fee items assessed to app # " + capIDString + " was not successful.  Reason: " +  invoiceResult.getErrorMessage());
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != null && stdDesc.length)
		...
		if (bizDomScriptResult.getSuccess())
			...
			logDebug("**ERROR creating Std Choice " + bizDomScript.ge() == existingType)
				{
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != null && stdDesc.length)
		...
		if (bizDomScriptResult.getSuccess())
			...
			logDebug("**ERROR creating Std Choice " + bizDomScript.geString
	}
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != null && stdDesc.length)
		...
		if (bizDomScriptResult.getSuccess())
			...
			logDebug("**ERROR creating Std Choice " + bizDomScript.ge	for (i in fcapParcelObj)
  		{
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != null && stdDesc.length)
		...
		if (bizDomScriptResult.getSuccess())
			...
			logDebug("**ERROR creating Std Choice " + bizDomScript.ge,pStatus,dispositionDate,wfnote,pComment,systemUserObj,"Y");
...
function updateShortNotes(newSN) // option CapId
	...
	if (cdWrite.getSuccess())
		{ logDebug("updated short notes to " +PeriodList);
	if (invoiceResult.getSuccess())
		logMessage("Invoicing assessed fee items is successful.");
	else
		logMessage("**ERROR: Invoicing the fee items assessed to app # " + capIDString + " was not successful.  Reason: " +  invoiceResult.getErrorMessage());
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != null && stdDesc.length)
		...
		if (bizDomScriptResult.getSuccess())
			...
			logDebug("**ERROR creating Std Choice " + bizDomScript.ge