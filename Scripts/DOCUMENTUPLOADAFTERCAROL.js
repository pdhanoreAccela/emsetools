...
categoryTaskMap.put("2 All permission","Application Acceptance,Building Review");


//task and discipline mapping relationship
var taskDisciplineMap = aa.util.newHashMap();
taskDisciplineMap.put("Application Acceptance","carol-test1");
...
var count = 1;   
//Mail from
var mailFrom = "cindy.qin@achievo.com";
//Mail CC
		...
		for(var i = 0; i < contacts.getOutput().length; i++)
		{
			...
			if("Applicant".equals(contactType))
			{
				...
				if(docModel.needResubmit())
				{
					...
					var acaServer = "http://devaa1.accela.com/default.aspx";
