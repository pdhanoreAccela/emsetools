/*------------------------------------------------------------------------------------------------------/
| Program : LicProfLookupSubmitAfterV1.5.js
...
var controlString = "LicProfLookupSubmitAfter";
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != nulde();
					if (cType==null)
						cType = " ";
					if (cStatus==null)
						cStatus = " ";
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != nulASI = sourceASI[ASICount];
...
function copyParcels(pFromCapId, pToCapId)
	...
	if (capParcelResult.getSuccess())
		...
		{
		logMessage("**ERROR: Failed to get parcels: " + capPar}
else
	{
	aa.env.setValue("ScriptReturnCode", "0");
	if (showMessage) aa.env.setValue("ScriptReturnMessage", message);
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != nulgetErrorMessage()) ; return false ; }
	}
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != nulgetErrorType() + ":" + bufchk.getErrorMessage()) ; return false }
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != nul	myFee.amount = fFee.getFee();
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != nulD().equals(tempArray[y].getCustomID()) )
...
function updateFee(fcode,fsched,fperiod,fqty,finvoice,pDuplicate,pFeeSeq)
	...
	if(pFeeSeq == null)
		getFeeResult = aa.finance.getFeeItemByFeeCode(capId,fcode,fp}
else
	{
	aa.env.setValue("ScriptReturnCode", "0");
	if (showMessage) aa.env.setValue("ScriptReturnMessage", message);
...
function addLookup(stdChoice,stdValue,stdDesc)
	...
	if (stdChoice != null && stdChoice.length && stdValue != null && stdValue.length && stdDesc != nul