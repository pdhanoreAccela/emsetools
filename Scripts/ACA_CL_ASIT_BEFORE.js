/*------------------------------------------------------------------------------------------------------/
| Program : ACA CL ASIT Before.js
| Event   : ACA CL ASIT Before
|
...
var controlString = "ACA CL PageFlowScript Before ASIT";		// Standard choice for control
...
function autoAssignInspection(iNumber)
	...
	if (!assignResult.getSuccess())
		...
		logDebug("Successfully reassigned inspection " + iObj.getInspectionType() + " to user "Internal Functions and Classes (Used by this script)
/------------------------------------------------------------------------------------------------------*/
function dateFormatted(pMonth,pDay,pYear,pFormat)
//returns date string formatted as YYYY-MM-DD or MM/DD/YYYY (default)
	{
...
function createRefLicProf(rlpId,rlpType,pContactType)
	...
	newLic.setZip(addrInternal Functions and Classes (Used by this script)
/------------------------------------------------------------------------------------------------------*/
function dateFormatted(pMonth,pDay,pYear,pFormat)
//returns date string formatted as YYYY-MM-DD or MM/DD/YYYY (default)
	{
...
function getChildren(pCapType, pParentCapId)
	...
	for (xx in childArray)
		...
		isMatch = truInternal Functions and Classes (Used by this script)
/------------------------------------------------------------------------------------------------------*/
function dateFormatted(pMonth,pDay,pYear,pFormat)
//returns date string formatted as YYYY-MM-DD or MM/DD/YYYY (default)
	{
...
function loadTasks(ltcapidstr)
	...
	for (i in wfObj)
		...
		myTask.process = fTaInternal Functions and Classes (Used by this script)
/------------------------------------------------------------------------------------------------------*/
function dateFormatted(pMonth,pDay,pYear,pFormat)
//returns date string formatted as YYYY-MM-DD or MM/DD/YYYY (default)
	{
...
function updateTaskAssignedDate(wfstr,wfAssignDate) // optional process name
	...
	for (i in wfObj)
		{
   		var fTask = wfObj[i];
 		if (fTask.getTaskDescription().toUpperCase().equals(wfstr.toUpInternal Functions and Classes (Used by this script)
/------------------------------------------------------------------------------------------------------*/
function dateFormatted(pMonth,pDay,pYear,pFormat)
//returns date string formatted as YYYY-MM-DD or MM/DD/YYYY (default)
	{
