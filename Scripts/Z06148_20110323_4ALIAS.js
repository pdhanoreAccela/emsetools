...
function batchCreateRecordsWithAPO(capTypeList, parentIDModel)
{
	var sectionNameList = aa.util.newArrayList();
 	...
 	sectionNameList.add("License");
        sectionNameList.add("Condition");
        sectionNameList.add("AdditionalInfo");
        sectionNameList.add("AppSpecificTable");
        sectionNameList.add("AppSpecificInfo");
        sectionNameList.add("Contact");
