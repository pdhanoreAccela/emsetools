...
aa.capCondition.createCapConditionFromStdCondition(capId, 10024662);
aa.capCondition.createCapConditionFromStdCondition(capId, 10024663);
aa.capCondition.createCapConditionFromStdCondition(capId, 10024664);
