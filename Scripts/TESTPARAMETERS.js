...
associate(id, altId+',RECORD;');

aa.print('Cap AltID: ' + altId);
aa.print('Communication Id ' + id);

aa.env.setValue("ScriptReturnCode","0");
aa.env.setValue("ScriptReturnMessage",'123456');
...
function getCapAltId()
{
	...
	var capIDModel = aa.cap.getCapID(s_id1, s_id2, s_id3).getOutput();
...
function sendEmailByModel(pTitle, pContent){
	...
	messageModel.setTriggerEvent('AdditionalInfoUpdateAfter');
